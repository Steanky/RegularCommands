...
public abstract class CommandForm<T> implements Iterable<Parameter> {
     ...
     */
    public CommandForm(Component usage, PermissionData permissionData, Parameter... parameters) {
    ...
    /**
     * Returns a short, user-friendly {@link Component} that should explain what the form does.
     * @return A user-friendly {@link Component} explaining what the CommandForm does
     */
     ...
     */
    public abstract CommandValidator<T, ?> getValidator(Context context, Object[] arguments);
